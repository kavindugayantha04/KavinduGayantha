...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[color:var(--border-color)] bg-[var(--surface-main)] py-10 transition-colors duration-300">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 md:flex-row md:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="rounded-lg px-3 py-2 text-xs font-medium text-[var(--text-muted)] transition hover:bg-[var(--nav-pill)] hover:text-[var(--text-primary)]"
          >
            Email
          </a>
        </div>
